...
export default function RegisterPage() {
  ...
  return (
    <AuthLayout
      eyebrow="Get started"
      headline="Give your first vague task somewhere to go."
      subhead="Create a project, drop in a task, and let TaskCraft turn it into a plan."
    >
      <div className="mb-7">
        ...
        <p className="mt-1.5 text-center text-sm text-[#6B6558]">
          Create an account to manage your tasks smarter
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-7">
        <div>
          ...
          <input
            ...
            className="w-full bg-transparent border-b-2 border-[#1B1E29]/15 py-2.5 px-2 text-base text-[#1B1E29] placeholder:text-[#1B1E29]/30 focus:outline-none focus:border-[#7C82B8] transition-colors"
      ...
      <p className="mt-9 text-center text-sm text-[#6B6558]">
        ...
        <Link to="/login" className="font-semibold text-[#1B1E29] hover:text-[#565c7e] transition-colors">
          Sign in
        </Link>
      </p>
    </AuthLayout>
